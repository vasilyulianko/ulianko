package net.ulianko.config.social;

import net.ulianko.repository.SocialUserConnectionRepository;
import net.ulianko.repository.CustomSocialUsersConnectionRepository;
import net.ulianko.security.social.CustomSignInAdapter;
