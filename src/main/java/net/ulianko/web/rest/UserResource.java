package net.ulianko.web.rest;

import com.codahale.metrics.annotation.Timed;
import net.ulianko.domain.Authority;
import net.ulianko.domain.User;
import net.ulianko.repository.AuthorityRepository;
import net.ulianko.repository.UserRepository;
import net.ulianko.security.AuthoritiesConstants;
import net.ulianko.service.MailService;
import net.ulianko.service.UserService;
import net.ulianko.web.rest.dto.ManagedUserDTO;
import net.ulianko.web.rest.dto.UserDTO;
import net.ulianko.web.rest.util.HeaderUtil;
import net.ulianko.web.rest.util.PaginationUtil;
